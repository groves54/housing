...
class InspectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inspection" do
    assert_difference('Inspection.count') do
      post inspections_url, params: { inspection: { apartmentID: @inspection.apartmentID, inspectionComment: @inspection.inspectionComment, inspectionDate: @inspection.inspectionDate, inspectionStatus: @inspection.inspectionStatus, inspectorID: @inspection.inspectorID } }
    end
  ...
  test "should update inspection" do
    patch inspection_url(@inspection), params: { inspection: { apartmentID: @inspection.apartmentID, inspectionComment: @inspection.inspectionComment, inspectionDate: @inspection.inspectionDate, inspectionStatus: @inspection.inspectionStatus, inspectorID: @inspection.inspectorID } }
