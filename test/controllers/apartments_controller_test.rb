...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post apartments_url, params: { apartment: { apartmentCity: @apartment.apartmentCity, apartmentNumOfRooms: @apartment.apartmentNumOfRooms, apartmentStreet: @apartment.apartmentStreet, apartmentZip: @apartment.apartmentZip } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { apartmentCity: @apartment.apartmentCity, apartmentNumOfRooms: @apartment.apartmentNumOfRooms, apartmentStreet: @apartment.apartmentStreet, apartmentZip: @apartment.apartmentZip } }
