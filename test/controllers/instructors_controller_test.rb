...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { instructorEmail: @instructor.instructorEmail, instructorFName: @instructor.instructorFName, instructorLName: @instructor.instructorLName, instructorPhone: @instructor.instructorPhone } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { instructorEmail: @instructor.instructorEmail, instructorFName: @instructor.instructorFName, instructorLName: @instructor.instructorLName, instructorPhone: @instructor.instructorPhone } }
